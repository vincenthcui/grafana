...
const (
	...
	defaultTemplate = "Title: {title}\r\nMessage: {message}\r\nUrl: {ruleUrl}\r\n" +
		"Pic: {picUrl}\r\nTime: {time}"
	helpUrl = "http://work.weixin.qq.com/api/doc?st=303C1EF34C5129D5A82536494080A6FBCEC1E6A1" +
		"F09F4BF987C7953269A0C742D351183C3D7483047231E79195159767419412B1824891744E6FC" +
		"0DD1B38E402DE22B64580BFBA699D4D0DFF190D88022A99D5930103A69185659691CF4764C341" +
		"0A89F639C0259A2D6400A198A2FE654E9BFEE4AA62DE8A9D28226D84A96E66452CEE5ED8FA69D" +
		"95480B4D35865B3F9&vid=1688850523107851&version=2.5.0.3027&platform=mac#14404"
)
      ...
      <div class="gf-form max-width-30">
        ...
        <div class="gf-form-select-wrapper width-14">
          <select class="gf-form-input"
			...
			ng-init="ctrl.model.settings.msgtype = '` + defaultMsgType + `'">
          </select>
        </div>
      </div>
      <div class="gf-form max-width-30">
        ...
        <textarea rows="7" class="gf-form-input width-27"
		  ...
		  ng-init="ctrl.model.settings.template= '` + defaultTemplate + `'"></textarea>
...
func NewWechatWorkNotifier(model *m.AlertNotification) (alerting.Notifier, error) {
	...
	template := model.Settings.Get("defaultTemplate").MustString()
	if template == "" {
...
func (w *WechatWorkNotifier) Notify(evalContext *alerting.EvalContext) error {
	...
	body := map[string]interface{}{
		...
		w.MsgType: map[string]string{
			"content": w.GenerateMessageBody(w.Template, title, message, ruleUrl, picUrl),
		},
	}
...
func (w *WechatWorkNotifier) GenerateMessageBody(body, title, message, ruleUrl, picUrl string) string {
	...
	body = strings.Replace(body, "{picUrl}", picUrl, -1)
	body = strings.Replace(body, "{time}", datetime, -1)
